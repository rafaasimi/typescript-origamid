...
function handleCursos(data) {
    if (Array.isArray(data)) {
        data.filter(isCursos).forEach(function (item) {
            document.body.innerHTML += "\n      <h1>Curso: ".concat(item.nome, "</h1>\n      <p>Quantidade de horas: ").concat(item.horas, "</p>\n      <p>").concat(item.tags.join(', '), "</p>\n    ");
        });
    }
}

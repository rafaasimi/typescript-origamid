...
function handleProduto() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetchProduto()];
                case 1:
                    produto = (_a.sent());
...
handleProduto();
// ! non_null operator
var videoNonNull = document.querySelector('video');
videoNonNull.volume;
document.querySelector('a').href = 'https://rafaelsimionato.dev';
// Outras sintaxes
var video1 = document.querySelector('.player');
var video2 = document.querySelector('.player');
var video3 = document.querySelector('.player'); // Mais seguro
var video4 = document.querySelector('.player');
video1.volume;
video2.volume;
